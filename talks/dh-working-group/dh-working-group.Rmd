...
ggplot(input, aes(x = x)) + 
  ...
  stat_function(fun = prob_for_graph5, linetype = 5) +
  theme_tufte() +
  labs(x = "Jaccard similarity",
       y = "Probability",
       title = "Probability of detecting a match given real similarity") +
